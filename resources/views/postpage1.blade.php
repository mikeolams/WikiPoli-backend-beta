...
<body>
			...
			<div class="navbar-collapse collapse" id="navbar9">
				<ul id="main-navbar" class="navbar-nav ml-auto"> 
					<li class="navbar-item mr-5">
						<a href="{{ url('/signin') }}" class="navbar-link" style="color: black;" id="logIn">Log In</a>
					</li>
					<li class="navbar-item mr-5">
						<a href="{{ url('/signup') }}" class="btn navbar-link" id="signUp" style="background-color: #6d9bf1;">Sign Up</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="pagination">
		<ul class="pages">
			...
			<li class="pageitem">
				<a href="{{ url('/post-page-1') }}" class="pagelink" style="color: #0000FF; font-size: 1.3em;">1</a>
			</li>
			<li class="pageitem">
				<a href="{{ url('/post-page-2') }}" class="pagelink" style="color: #333333; font-size: 1.2em;">2</a>
			<li class="pageitem">
				<a href="{{ url('/post_page_3') }}" class="pagelink" style="color: #333333; font-size: 1.2em;">3</a>
			</li>
					...
					<div class="row links">
						...
						<div class="col-md-4 col-sm-12  text-center">
							<ul class="quick-links">
								...
								<li><a href="{{ url('donation_page') }}">Donations</a></li>
							</ul>
						</div>
