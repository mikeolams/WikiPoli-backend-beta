        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="nav navbar-nav ml-auto menu">
            <li class="nav-item active">
              <a class="nav-link " href="{{ url('/postpage1') }}"><strong>Posts</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/signin') }}" ><strong>Login</strong></a>
            </li>
          </ul>
            <a href= "{{ url('/signup') }}"  class="button-signup">Sign Up</a>
        </div>
      </nav>
    </div>
        ...
        <div class="col-lg-12">
          <div class="form-content">
            ...
            <form>
              ...
              <div class="col-lg-12">
                <p class="search-content">Search for Candidates in your election, get to know them. Contribute posts and add to existing posts.<a href="{{ url('/signin') }}"> Get Started</a>
                </p>
              </div>
          </div>
        </div>
